...
#define DECODER_TIM_CH          1
#define DECODER_TIM_CH_DEF      TIM_Channel_1
#define DECODER_TIM_CH_INT_DEF  TIM_IT_CC1
#define DECODER_TIM_CH_CCR      CCR1

#define DECODER_PIN             6

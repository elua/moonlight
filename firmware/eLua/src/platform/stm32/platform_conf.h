...
#define WIZ_NUM_MAX_SOCKETS   4

// *****************************************************************************
// UART/Timer IDs configuration data (used in main.c)

#define CON_UART_ID           ( SERVICE_ID_FIRST + 1 )
...
#define PS_DP105_NAME         "dp105"
#define PS_SIRCS_NAME         "sircs"
#define PS_SND_NAME           "snd"
...
#define PSLINE _ROM( PS_LIB_TABLE_NAME, luaopen_platform, platform_map )
#else
#define PSLINE
#endif
...
#define LUA_PLATFORM_LIBS_ROM\
  ...
  _ROM( AUXLIB_WIZ, luaopen_wiz, wiz_map )\
  PSLINE
...
#define RFS_UART_ID           SERVICE_ID_FIRST
#define RFS_TIMER_ID          0
#define RFS_TIMEOUT           1000000
#define RFS_UART_SPEED        115200

// WizNET client data
#define WIZ_UART_ID           0
#define WIZ_UART_SPEED        115200
#define WIZ_BUFFER_SIZE       BUF_SIZE_512
#define WIZ_TIMER_ID          0
#define WIZ_TIMEOUT           ( -1 )

// Serial multiplexer
#define SERMUX_PHYS_ID        1
#define SERMUX_PHYS_SPEED     115200
#define SERMUX_NUM_VUART      4

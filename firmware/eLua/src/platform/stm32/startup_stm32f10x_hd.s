...
SystemInit_ExtMemCtl_Dummy:
	...
	.size	SystemInit_ExtMemCtl_Dummy, .-SystemInit_ExtMemCtl_Dummy
		...
		.section	.text.cortex_enable_interrupts,"ax",%progbits
		.global   cortex_enable_interrupts
		.thumb_func
cortex_enable_interrupts:
  cpsie i
	bx	lr
	.size	cortex_enable_interrupts, .-cortex_enable_interrupts
	
		.section	.text.cortex_disable_interrupts,"ax",%progbits
		.global   cortex_disable_interrupts
    .thumb_func		
cortex_disable_interrupts:
  cpsid i
	bx	lr
	.size	cortex_disable_interrupts, .-cortex_disable_interrupts	
